        ...
        <div className='body'>
            ...
            <div className='layer-top-upper-detail-class'>
                ...
                <div className='two-layer-detail-class-upper'>
                    ...
                    <span className='title-detail-class-upper'>Thiết lập</span>
                </div>
            </div>
            ...
            <div className='content-course-detail'>
                <div className="view-course-detail-1 w-1347" onClick={() => HandleClick()}>
                    ...
                    <span className='title-course-detail'>Chấm điểm</span>
                    </div>
