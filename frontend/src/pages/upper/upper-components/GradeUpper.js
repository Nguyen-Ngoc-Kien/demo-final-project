...
import TableClassUpper from './../../../UI/TableClass/TableClassUpper'
import { fetchCourseById } from '../../../services/UserServices';
        ...
        <div className='grade-body'>
            ...
            <div className='table-grade'>
                ...
                <div className='col-grade'>
                    <TableClassUpper filterStatus={filterStatus}></TableClassUpper>
                </div>
            </div>
        </div>
        </div>
