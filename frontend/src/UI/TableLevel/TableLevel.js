...
import {fetchAllLevel} from '../../services/UserServices';
import ReactPaginate from 'react-paginate';
import ModalAddnew from './ModalAddnew';
import { ToastContainer, toast } from 'react-toastify';
import ModalEditUser from './ModalEditLevel';
...
const handleDeleteUser = (user) => {
  ...
  const getUsers = async (page) => {
    let res = await fetchAllLevel(page,localStorage.getItem("access_token"));
    console.log("res >>>",res)
    if(res){
