...
import {fetchAllDepartment} from '../../services/UserServices';
...
const handleDeleteUser = (user) => {
  ...
  const handleEditUserFromModal = (user) => {
    ...
    cloneListUsers[index].name = user.departmentName;
  ...
  const getUsers = async (page) => {
    let res = await fetchAllDepartment(page,localStorage.getItem("access_token"));
    console.log("res >>>",res)
